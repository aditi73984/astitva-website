  ...
  const BlogSection: React.FC = () => {
    ...
    // Automatically sort newest first
    ...
    return (
      <section
        id="blog"
        className="py-32 bg-[#F8FAFF] relative overflow-hidden"
      >
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="flex flex-col items-center text-center max-w-3xl mx-auto mb-20">
            ...
            <h2 className="text-4xl md:text-6xl font-black text-slate-900 leading-tight mb-6 tracking-tight">
              Nurturing Minds through{" "}
              <span className="text-blue-600 italic">Knowledge</span>
            </h2>
          ...
          <div className="mt-20 text-center">
            <button className="inline-flex items-center gap-3 text-slate-900 font-black uppercase text-xs tracking-[0.2em] hover:text-blue-600 transition-colors group">
              Browse All Articles
              <div className="w-8 h-[2px] bg-blue-600 group-hover:w-12 transition-all" />
            </button>
          </div>
        </div>
      </section>
